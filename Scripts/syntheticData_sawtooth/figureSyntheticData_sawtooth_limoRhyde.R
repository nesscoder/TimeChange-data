...
apply(gridOfparams, 1, function(params) {
  ...
  load(paste0("~/Desktop/TimeChange-data/Results/syntheticData_sawtooth/limoRhyde/", fileName, ".RData"))
  ...
  ouputFile <- paste0("~/Desktop/TimeChange-data/Results/syntheticData_sawtooth/limoRhyde/figs/", fileName, ".png")
