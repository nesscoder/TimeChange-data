...
apply(gridOfparams, 1, function(params) {
  ...
  load(paste0("~/Desktop/TimeChange-data/Results/syntheticData_dphase/timeChange/", fileName, ".RData"))
  ...
  ouputFile <- paste0("~/Desktop/TimeChange-data/Results/syntheticData_dphase/timeChange/figs/", fileName, ".png")
